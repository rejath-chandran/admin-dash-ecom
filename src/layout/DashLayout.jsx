          ...
          <div className={`flex-1 w-full transition-all duration-300 ${isDesktop ? "ml-4" : "ml-0"}`}>
            ...
            <div className="flex items-center justify-between mb-4 md:mb-6">
              ...
              <div className="flex items-center gap-2 md:gap-3 relative"> {/* Added relative for dropdown positioning */}
                ...
                <button 
                  className={`flex items-center gap-2 px-2 md:px-3 py-2 rounded-lg shadow-md border hover:shadow-lg transition-all duration-200 ${
                    darkMode 
                      ? "bg-gray-800 border-gray-700" 
                      : "bg-white border-gray-100"
                  }`}
                ...
                {showUserMenu && (
                  <div 
                    className={`absolute top-full right-0 mt-2 w-48 rounded-lg shadow-xl py-1 z-50 transition-all duration-200 transform origin-top-right ${
